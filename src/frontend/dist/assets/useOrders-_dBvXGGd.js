...
Service({
  ...
  "updateOrderStatus": Func([Nat, Text], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const Order2 = IDL2.Record({
    ...
    "status": IDL2.Text,
    "serviceName": IDL2.Text,
    "fileUrls": IDL2.Vec(IDL2.Text),
    "email": IDL2.Text,
    "timestamp": IDL2.Int,
    "phone": IDL2.Text
  });
  return IDL2.Service({
    ...
    "updateOrderStatus": IDL2.Func([IDL2.Nat, IDL2.Text], [IDL2.Bool], [])
  });
};
class Backend {
  ...
  async addOrder(arg0, arg1, arg2, arg3, arg4) {
